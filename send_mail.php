...
<?php
  ...
  $sql1="update job_apply set job_status='accepted' where id='$id' ";
...
<td><input type="email" name="from" id="from" class="form-control" value="<?php echo $_SESSION['email']; ?>"></td> 	
</div>
