  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
         <nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="#">Jobseeker Details</a></li>
			  </ol>
			</nav>


        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
		 <h1 class="h2">Jobseeker Deatils</h2>
...
<?php
  ...
  ?>
			  ...
			  <div class="form-group">
			   ...
			   <td> <a href="http://localhost:8080/job_portal/files/<?php echo  $row['img']; ?>" >Download file</a></td>
				</div>
			   
				<div class="form-group">
               <label for="">Job Seeker Applied Date: </label>
