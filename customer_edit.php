...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
		   ...
		   <nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="customer.php">Admin</a></li>
          ...
          <div style="width: 60%; margin-left: 20%; background:#F2F4F4;">
		    ...
		    <form action="" method="post" style="margin:3%; padding: 3%;" name="customer_form" id="customer_form">
				  ...
				  <div class="form-group">
					...
					<input type="pass" name="Password" id="Password" value="<?php echo $admin_pass;  ?>" class="form-control" placeholder="Enter Customer password">
				  </div>
				  <div class="form-group">
...
{
	echo "<script>alert('some eroor please try again!!!')</script>";
}
